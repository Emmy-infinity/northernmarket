...
# Force CORS headers – add this at the bottom of settings.py
def force_cors_headers(get_response):
...
MIDDLEWARE.insert(0, "django.middleware.common.CommonMiddleware")  # Keep below
# Actually, just add this at the very end of MIDDLEWARE list:
# But to be safe, add a custom middleware file instead.
